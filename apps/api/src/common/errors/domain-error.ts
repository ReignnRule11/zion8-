...
const DEFAULT_STATUS: Partial<Record<ErrorCode, number>> = {
  ...
  [ErrorCode.ACCOUNT_CODE_TAKEN]: 409,
  [ErrorCode.ACCOUNT_NOT_POSTABLE]: 409,
  [ErrorCode.ACCOUNT_ARCHIVED]: 409,
  [ErrorCode.PERIOD_NOT_FOUND]: 404,
  [ErrorCode.PERIOD_CLOSED]: 409,
  [ErrorCode.PERIOD_OVERLAP]: 409,
  [ErrorCode.JOURNAL_NOT_FOUND]: 404,
  [ErrorCode.JOURNAL_NOT_BALANCED]: 400,
  [ErrorCode.JOURNAL_ALREADY_POSTED]: 409,
  [ErrorCode.JOURNAL_ALREADY_VOID]: 409,
  [ErrorCode.FUND_NOT_FOUND]: 404,
  [ErrorCode.CONTRIBUTION_NOT_FOUND]: 404,
  [ErrorCode.CONTRIBUTION_NOT_REFUNDABLE]: 409,
  [ErrorCode.PAYROLL_EMPLOYEE_NOT_FOUND]: 404,
  [ErrorCode.PAYROLL_RUN_NOT_FOUND]: 404,
  [ErrorCode.PAYROLL_RUN_EMPTY]: 409,
  [ErrorCode.PAYROLL_RUN_NOT_POSTABLE]: 409,
  [ErrorCode.BUDGET_NOT_FOUND]: 404,
  [ErrorCode.PROJECT_NOT_FOUND]: 404,
  [ErrorCode.VENDOR_NOT_FOUND]: 404,
  [ErrorCode.PURCHASE_ORDER_NOT_FOUND]: 404,
  [ErrorCode.PURCHASE_ORDER_NOT_APPROVABLE]: 409,
  [ErrorCode.BILL_NOT_FOUND]: 404,
  [ErrorCode.BILL_NOT_POSTABLE]: 409,
  [ErrorCode.EXPENSE_NOT_FOUND]: 404,
  [ErrorCode.EXPENSE_NOT_APPROVABLE]: 409,
  [ErrorCode.BANK_ACCOUNT_NOT_FOUND]: 404,
  [ErrorCode.BANK_TRANSACTION_NOT_FOUND]: 404,
  [ErrorCode.RECONCILIATION_NOT_FOUND]: 404,
  [ErrorCode.RECONCILIATION_ALREADY_COMPLETED]: 409,
  [ErrorCode.RECONCILIATION_UNBALANCED]: 409,
  [ErrorCode.NOTIFICATION_TEMPLATE_NOT_FOUND]: 404,
  [ErrorCode.NOTIFICATION_AUDIENCE_NOT_FOUND]: 404,
  [ErrorCode.NOTIFICATION_CAMPAIGN_NOT_FOUND]: 404,
  [ErrorCode.NOTIFICATION_CAMPAIGN_NOT_SENDABLE]: 409,
  [ErrorCode.NOTIFICATION_CAMPAIGN_EMPTY]: 409,
  [ErrorCode.NOTIFICATION_MESSAGE_NOT_FOUND]: 404,
